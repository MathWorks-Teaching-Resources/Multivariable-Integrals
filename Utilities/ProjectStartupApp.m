...
%}
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.WelcomeTitle.Text = 'Welcome to Multivariable: Integrals';
            ...
            app.Image.ImageSource = 'cycleWorkArea.png';
            ...
            app.ReviewTitle.Text = 'Welcome to Multivariable: Integrals';
